...
public class Romano {
	...
	static String NumerosRomanos[][] = { { "I", "1" }, { "V", "5" }, { "X", "10" }, { "L", "50" }, { "C", "100" },
			{ "D", "500" }, { "M", "1000" } };
	...
	static public String romano(String texto) {
		...
		if (ConteoNumeroCompuestoI < 4 && ConteoNumeroCompuestoX < 4 && ConteoNumeroCompuestoC < 4
				&& ConteoNumeroCompuestoM < 4 && ConteoNumeroCompuestoV < 2 && ConteoNumeroCompuestoL < 2
			...
			if (valorFinal == 0) {
				cadenaAmanipular = "hay error al teclear el romano";
			} else {
